...
public class MapsController : ControllerBase
{
    ...
    public IEnumerable<Maps> Post()
    {
        ...
        var map = new Maps() { MapName = "Tavern", CreatorId = "Blindy", Id = "Blindy_1_PowerAdmin", MapFile = fileByteArray};
       System.IO.File.WriteAllBytes(@"F:\Repo\Mersis\OutputFolder\Port_City_output.zip", (fileByteArray));
        return Enumerable.Range(1, 5).Select(index => new Maps
            {
                MapName = "Tavern",
                CreatorId = "Blindy",
                Id = "Blindy_1_PowerAdmin",
